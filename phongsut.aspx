<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phongsut.aspx.cs" Inherits="quanlikhachsan.phongsut" %>
        ...
        <div id="slideanh">
            ...
            <div class="slideshow-container">
                <div class="mySlides fade">
                    <asp:Image ID="suit1" runat="server" ImageUrl="https://znews-photo-td.zadn.vn/w1024/Uploaded/pgi_xvauqbnau/2014_02_21/p1.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image1" runat="server" ImageUrl="http://www.alisapremiercruise.com/upload/cache/870x496/images/Family%20Suite%20Connecting%20Private%20Balcony%202.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image2" runat="server" ImageUrl="https://westernhanoihotel.com/wp-content/uploads/2018/05/suite-1.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image3" runat="server" ImageUrl="http://www.halongplaza.com/FileManager/Suite%20Bathroom%20-%20Copy%201.jpg" Style="width: 100%" />
                </div>
                <div class="mySlides fade">
                    <asp:Image ID="Image4" runat="server" ImageUrl="http://www.halongplaza.com/FileManager/Executive%20Suite_Living%20room1.jpg" Style="width: 100%" />
                </div>
            </div>
         ...
         <div style="margin-top:20px">
                <asp:Label ID="lbsut" Text="PHÒNG SUITE" runat="server" Font-Bold="True" font-size="20px" Font-Underline="False" ForeColor="#FF9900"></asp:Label><br />
               <hr />
             <section>
                   <article>
                       ...
                       Phòng được trang bị đầy đủ tiện nghi phù hợp cho kỳ nghĩ dưỡng, du lịch khám phá của quý khách. Phòng rộng khoảng 70m2.<br/>
                       Phòng được bố trí phòng khách và phòng ngủ riêng biệt<br />
