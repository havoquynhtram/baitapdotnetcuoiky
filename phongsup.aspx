<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phongsup.aspx.cs" Inherits="quanlikhachsan.phongsup" %>
        ...
        <div id="slideanh">
                ...
                <div class="slideshow-container">
                    <div class="mySlides fade">
                        <asp:Image ID="sup1" runat="server" ImageUrl="http://edelehotel.vn/FileStorage/ServicePicture/Thumbnail/Superior-1.JPG" Style="width: 100%" />
                    </div>     
                     <div class="mySlides fade">
                        <asp:Image ID="Image1" runat="server" ImageUrl="http://edelehotel.vn/FileStorage/ServicePicture/Thumbnail/Superior-2.JPG" Style="width: 100%" />
                    </div>
                     <div class="mySlides fade">
                        <asp:Image ID="Image2" runat="server" ImageUrl="http://edelehotel.vn/FileStorage/ServicePicture/Thumbnail/Superior-3.JPG" Style="width: 100%" />
                    </div>
                     <div class="mySlides fade">
                        <asp:Image ID="Image3" runat="server" ImageUrl="http://edelehotel.vn/FileStorage/ServicePicture/Thumbnail/Superior-4.JPG" Style="width: 100%" />
                    </div>              
                </div>
         ...
         <div style="margin-top:20px">
                <asp:Label ID="lblhnghi" Text="PHÒNG SUPERIOR" runat="server" Font-Bold="True" font-size="20px" Font-Underline="False" ForeColor="#FF9900"></asp:Label><br />
                <hr />
             <section>
                   <article>
                       ...
                       Phòng được trang bị đầy đủ tiện nghi phù hợp cho kỳ nghĩ dưỡng, du lịch khám phá của quý khách. Phòng rộng khoảng 48m2.<br/>
                       - Phòng nằm ở vị trí hướng biển. <br /> 
                       Giá phòng: 1.100.000đ/ đêm <br />     
                       </article>
                   <article>                   
